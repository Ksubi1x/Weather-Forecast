...
button.addEventListener("click", () => {
    ...
    if (isNaN(retrieve)){
        ...
        queryURL = "http://api.openweathermap.org/geo/1.0/zip?zip=" + retrieve + "&appid=" + ApiKey
    ...
    .then(data => {
        ...
        weatherURL = "http://api.openweathermap.org/data/2.5/forecast?lat=" + latitude + "&lon=" + longitude + "&appid=" + ApiKey
        fetch(weatherURL)  
            .then(res => res.json())
